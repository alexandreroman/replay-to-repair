...
- [Engine credentials and model ids are environment variables](references/engine-env-var-naming.md) — TYPESAFE_API_KEY follows the official SDK; TYPESAFE_MODEL mirrors ANTHROPIC_MODEL
